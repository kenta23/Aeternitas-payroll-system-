			   ...
			   <!-- Flag -->
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ route('profile_user') }}"><i class="fa fa-user" style="margin-right:10px;"></i>My Profile</a>
						<a class="dropdown-item" href="{{ route('company/settings/page') }}"><i class="fa fa-cog" style="margin-right:10px;"></i>Settings</a>
						<a class="dropdown-item" href="{{ route('logout') }}"><i class="fa fa-sign-out" style="margin-right:10px"></i>Logout</a>
					</div>
				</li>
			</ul>
			<!-- /Header Menu -->
